...
public final class BitSet {
    ...
    /**
     * Creates a new {@link BitSet} using the specified memory block. Size of the memory block must be multiple of 8 bytes (i.e. 64 bits).
     */
    ...
    /**
     * Returns the index of the first bit that is set to true that occurs on or after the specified starting index. If no such bit exists then
     * {@code -1} is returned.
     * <p>
